...
export function applySecurity(req, res) {
  ...
  res.setHeader('Content-Security-Policy', [
    ...
    "frame-src https://challenges.cloudflare.com https://www.youtube.com https://youtube.com https://www.youtube-nocookie.com https://player.vimeo.com https://www.loom.com https://*.typeform.com",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
